...
;(function ($, window, document, undefined) {
    ...
    fn.calculate_overlapped_area_coords = function (a, b) {
        ...
        return $({left: x1, top: y1, width: (x2 - x1), height: (y2 - y1)}).coords().get();
    };
...
;(function ($, window, document, undefined) {
    ...
    fn.on_dragstart = function (e) {
        ...
        if (this.options.start) {
            this.options.start.call(this.$player, e, {helper: this.helper ? this.$helper : this.$player});
        }
        return false;
    };
...
;(function ($, window, document, undefined) {
    ...
    fn.remove_empty_cells = function (col, row, size_x, size_y, exclude) {
        var $nexts = this.widgets_below({col: col, row: row, size_x: size_x, size_y: size_y});
    ...
    fn.next_position = function (size_x, size_y) {
        ...
        for (var c = 1; c < cols_l; c++) {
            ...
            for (var r = 1; r <= rows_l; r++) {
                var can_move_to = this.can_move_to({size_x: size_x, size_y: size_y}, c, r);
                if (can_move_to) {
                    valid_pos.push({col: c, row: r, size_y: size_y, size_x: size_x});
                }
            }
        }
        if (valid_pos.length) {
    ...
    fn.on_start_drag = function (event, ui) {
        ...
        this.$preview_holder = $('<li />', {
            ...
            css: {width: coords.width, height: coords.height}
        }).appendTo(this.$el);
    ...
    fn.on_drag = function (event, ui) {
        ...
        if (this.helper && this.$player) {
            this.$player.css({'left': ui.position.left, 'top': ui.position.top});
        }
